...
module.exports.run = async (client, message, args, fs, colors, database, dataServer, language) => {
    ...
    if (fetched.dispatcher.paused) return await msg.sendMsgA(language("MUSIC_ALREADY_PAUSE",dataServer.prefix,fetched.queue[0].songTitle), message, dataServer);
    fetched.dispatcher.pause();
    return await msg.sendMsgA(language("MUSIC_PAUSE",dataServer.prefix,fetched.queue[0].songTitle), message, dataServer);
}
